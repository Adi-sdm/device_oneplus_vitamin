#!/usr/bin/env -S PYTHONPATH=../../../tools/extract-utils python3.12
#
...
blob_fixups: blob_fixups_user_type = {
    ...
    'system_ext/priv-app/ImsService/ImsService.apk': blob_fixup()
        .apktool_patch('blob-patches/ImsService-AndroidManifest.patch', '-s')
        .apktool_patch('blob-patches/ImsService-smali.patch', '-r'),
    ...
    'vendor/lib64/mt6983/libmtkcam_stdutils.so': blob_fixup()
        .replace_needed('libutils.so', 'libutils-v32.so'),
}  # fmt: skip
