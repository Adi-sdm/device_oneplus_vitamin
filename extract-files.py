...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/libcustomer_cameradata.so', 'vendor/lib64/hw/hwcomposer.mtk_common.so', 'vendor/lib64/mt6983/libcam.hal3a.so',
    'vendor/lib64/mt6983/libcam.hal3a.ctrl.so', 'vendor/lib64/mt6983/libmtkcam_request_requlator.so'): blob_fixup()
